...
import PickedBlockToChangeContext from "./context/PickedBlocksToChangeContext";
...
function App() {
	...
	console.log("appjs boards:",boards);
							...
							<Routes>
								...
								{!isAuth ? (
									...
									<>
										<Route
											path="/home1"
											element={<Home1 isAuth={isAuth} />}
										/>
										<Route
											path="/playingboard"
											element={
												<PlayingBoard isAuth={isAuth} />
											}
										/>
										<Route
											path="/savedboards"
